...
class Layout_CPT_Single extends Base_Customizer {
	...
	private function post_meta() {
		...
		if ( $has_custom_meta ) {
			...
			$default_value     = Layout::get_meta_default_data( 'neve_single_' . $this->model->get_type() . '_meta_ordering', Mods::get( 'neve_single_post_meta_ordering', $order_default_components ) );
